...
| **Type-check** | `npm run lint` (`tsc --noEmit`) | No TypeScript type errors across the full source tree. |
...
- **Type-check fails** → TypeScript found type errors; run `npm run lint` locally and fix the reported files.
